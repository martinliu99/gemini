...
public interface AspectJAdvice {
    ...
    class ClassMaker {
        ...
        private static final Logger LOGGER = LoggerFactory.getLogger(AspectRepository.class);
        ...
        public Class<? extends Advice> make(AspectEnvironment aspectEnvironment) {
            ClassLoader cacheKey = aspectEnvironment.getClassLoader();
            ...
            if(adviceClassRefMap.containsKey(cacheKey) == false) {
                adviceClassRefMap.computeIfAbsent(
                        ...
                        key -> {
                            ...
                            this.adviceClassUnloaded = ByteCodeGenerator.INSTANCE.make(aspectEnvironment, this);

                            Class<? extends Advice> adviceClass = adviceClassUnloaded
                                    .load(cacheKey, new ClassLoadingStrategy.ForUnsafeInjection())
                                    .getLoaded();
                            LOGGER.info("Took '{}' seconds to inject aspectClass '{}' into classloader '{}'.", 
    ...
    enum ByteCodeGenerator {
        ...
        @SuppressWarnings("unchecked")
        public DynamicType.Unloaded<? extends Advice> make(AspectEnvironment aspectEnvironment, ClassMaker classMaker) {
            ...
            if(aspectEnvironment.isASMAutoCompute()) {
