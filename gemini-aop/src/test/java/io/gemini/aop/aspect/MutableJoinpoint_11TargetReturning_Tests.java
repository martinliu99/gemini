 ...
 * @since	 1.0
 */
public class MutableJoinpoint_11TargetReturning_Tests extends AbstractBaseTests {
    ...
    public static class TypeInitilizer_BeforeAdvice_Aspects {
        ...
        @Before("staticinitialization(io.gemini.aop.aspect.MutableJoinpoint_11TargetReturning_Tests$TypeInitilizer_BeforeAdvice_Objects)")
    ...
    public static class TypeInitilizer_AfterAdvice_Aspects {
        ...
        @SuppressWarnings("rawtypes")
        @After("staticinitialization(io.gemini.aop.aspect.MutableJoinpoint_11TargetReturning_Tests$TypeInitilizer_AfterAdvice_Objects)")
        public void typeInitializer(MutableJoinpoint joinpoint) {
            ExecutionMemento.putAdviceMethodInvoker(ADVICE_TYPE_INITIALIZER, 
                    new AdviceMethod()
                        .withInvoked(true)
    ...
    public static class ClassMethod_Advices {
        ...
        private static final String TARGET_RETURNING_POINTCUT = 
                "execution(public static * io.gemini.aop.aspect.MutableJoinpoint_11TargetReturning_Tests$ClassMethod_Objects.targetReturning())";
    ...
    public static class InstanceConstructor_Advices {
        ...
        private static final String TARGET_RETURNING_POINTCUT = 
                "execution(public io.gemini.aop.aspect.MutableJoinpoint_11TargetReturning_Tests$InstanceConstructor_Objects.new(int))";
    ...
    public static class InstanceMethod_Aspects {
        ...
        private static final String TARGET_RETURNING_POINTCUT = 
                "execution(public * io.gemini.aop.aspect.MutableJoinpoint_11TargetReturning_Tests$InstanceMethod_Objects.targetReturning())";
