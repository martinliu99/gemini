...
public class DefaultAgentListener implements Listener {

    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultAgentListener.class);

    private final AopContext aopContext;
    private final TypePoolFactory typePoolFactory;

    public DefaultAgentListener(AopContext aopContext) {
