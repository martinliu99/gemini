...
import io.gemini.aop.aspect.Advice.After;
import io.gemini.aop.aspect.Advice.Around;
import io.gemini.aop.aspect.Advice.Before;
...
public interface Joinpoint {
    ...
    interface MutableJoinpoint<T, E extends Throwable> extends Joinpoint {
        ...
        class Default<T, E extends Throwable> extends AbstractBase<T, E> implements MutableJoinpoint<T, E> {
            ...
            public Default(Descriptor descriptor, Object thisObject, Object[] arguments) {
        ...
        class Dispatcher<T, E extends Throwable> implements BootstrapAdvice.Dispatcher<T, E> {

            private static final Logger LOGGER = LoggerFactory.getLogger(Dispatcher.class);

            private final AopContext aopContext;

            private Default<T, E> joinpoint = null;
            ...
            public Dispatcher(Descriptor descriptor, Object thisObject, Object[] arguments, AopContext aopContext) {
                ...
                try {
                    ...
                    joinpoint = new Default<T, E>(descriptor, thisObject, arguments);
    ...
    interface ProceedingJoinpoint<T, E extends Throwable> extends Joinpoint {
        ...
        class Default<T, E extends Throwable> extends AbstractBase<T, E> implements ProceedingJoinpoint<T, E> {
