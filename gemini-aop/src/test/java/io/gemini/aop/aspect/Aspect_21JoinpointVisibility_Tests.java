 ...
 * @since	 1.0
 */
public class Aspect_21JoinpointVisibility_Tests extends AbstractBaseTests {
    ...
    public static class TargetObjectVisibility_Aspects {
        ...
        private static final String ACCESS_TARGET_OBJECT_POINTCUT = 
                "execution(!private long io.gemini.aop.aspect.Aspect_21JoinpointVisibility_Tests$TargetObjectVisibility_Objects.accessTargetObject()) && this(targetObject)";
    ...
    public static class TargetArgumentVisibility_Aspects {
        ...
        private static final String ACCESS_TARGET_ARGUMENT_POINTCUT = 
                "execution(!private long io.gemini.aop.aspect.Aspect_21JoinpointVisibility_Tests$TargetArgumentVisibility_Objects.accessTargetArgument(..)) && args(argument)";
    ...
    public static class TargetReturningVisibility_Aspects {
        ...
        private static final String ACCESS_TARGET_RETURNING_POINTCUT = 
                "execution(* io.gemini.aop.aspect.Aspect_21JoinpointVisibility_Tests$TargetReturningVisibility_Objects.accessTargetReturning())";
    ...
    public static class TargetThrowingVisibility_Aspects {
        ...
        private static final String ACCESS_TARGET_THROWING_POINTCUT = 
                "execution(!private void io.gemini.aop.aspect.Aspect_21JoinpointVisibility_Tests$TargetThrowingVisibility_Objects.accessTargetThrowing())";
    ...
    public static class ParametrizedReturninggVisibility_Aspects {
        ...
        private static final String ACCESS_TARGET_RETURNING_POINTCUT = 
                "execution(!private io.gemini.aop.aspect.Aspect_21JoinpointVisibility_Tests$ParametrizedReturninggVisibility_Objects$Returning io.gemini.aop.aspect.Aspect_21JoinpointVisibility_Tests$ParametrizedReturninggVisibility_Objects.accessParametrizedReturningg())";
    ...
    public static class ParametrizedThrowingingVisibility_Aspects {
        ...
        private static final String ACCESS_TARGET_THROWING_POINTCUT = 
                "execution(!private void io.gemini.aop.aspect.Aspect_21JoinpointVisibility_Tests$ParametrizedThrowingingVisibility_Objects.accessParametrizedThrowinging())";
