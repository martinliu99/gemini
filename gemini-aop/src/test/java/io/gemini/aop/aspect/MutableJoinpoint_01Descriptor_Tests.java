 ...
 * @since	 1.0
 */
public class MutableJoinpoint_01Descriptor_Tests extends AbstractBaseTests {
    ...
    public static class TypeInitializer_BeforeAdvice_Aspects {
        ...
        @Before("staticinitialization(io.gemini.aop.aspect.MutableJoinpoint_01Descriptor_Tests$TypeInitializer_BeforeAdvice_Objects)")
    ...
    public static class TypeInitializer_AfterAdvice_Aspects {
        ...
        @SuppressWarnings("rawtypes")
        @Before("staticinitialization(io.gemini.aop.aspect.MutableJoinpoint_01Descriptor_Tests$TypeInitializer_AfterAdvice_Objects)")
        public void typeInitializer(MutableJoinpoint joinpoint) {
            ExecutionMemento.putAdviceMethodInvoker(ADVICE_TYPE_INITIALIZER, 
                    new AdviceMethod()
                        .withInvoked(true)
    ...
    public static class ClassMethod_Advices {
        ...
        private static final String DESCRIPTOR_POINTCUT = 
                "execution(public static void io.gemini.aop.aspect.MutableJoinpoint_01Descriptor_Tests$ClassMethod_Objects.descriptor())";
    ...
    public static class InstanceConstructor_Advices {
        ...
        private static final String DESCRIPTOR_POINTCUT = 
                "execution(public io.gemini.aop.aspect.MutableJoinpoint_01Descriptor_Tests$InstanceConstructor_Objects.new(byte))";
    ...
    public static class InstanceMethod_Aspects {
        ...
        private static final String DESCRIPTOR_POINTCUT = 
                "execution(public void io.gemini.aop.aspect.MutableJoinpoint_01Descriptor_Tests$InstanceMethod_Objects.descriptor())";
