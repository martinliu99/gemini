...
public interface Aspect {
    ...
    interface PointcutAspect extends Aspect, Ordered {

        Pointcut getPointcut();


        abstract class AbstractBase implements PointcutAspect {
            ...
            public String toString() {
                return this.getAspectName() + "@" + ObjectUtils.getIdentityHexString(this);
            }
        }
