...
/**
 * Activates an advisor only when the specified constructor is present in the target type.
 *
 * @author   martin.liu
 */
...
public @interface ConditionalOnConstructor {
    ...
    /**
     * The constructor expression that must be present in the target type.
     *
