...
import io.gemini.aop.aspect.AspectSpec.PojoPointcutSpec;
...
public class Pointcut_01JoinpointMatching_Tests extends AbstractBaseTests {
    ...
    public static class VoidMatching_Aspects {
        ...
        private static final String MATCH_VOID_POINTCUT = 
                "execution(void io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$VoidMatching_Objects.matchVoid())";
    ...
    public static class VoidMatching_Advices extends Advice.AbstractAfter<Void, RuntimeException> 
        ...
        public PojoPointcutSpec getAspectSpec() {
            return new AspectSpec.PojoPointcutSpec.Builder()
                    ...
                    .typeMatcher(
                            named("io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$VoidMatching_Objects") )
                    .methodMatcher(
                            named("matchVoid")
                                .and(isPrivate())
    ...
    public static class PrimitiveMatching_Aspects {
        ...
        private static final String MATCH_PRIMITIVE_POINTCUT = 
                "execution(!private long io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$PrimitiveMatching_Objects.matchPrimitive(long))";
        ...
        private static final String MATCH_PRIMITIVE2_POINTCUT = 
                "execution(!private java.lang.Long io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$PrimitiveMatching_Objects.matchPrimitive(java.lang.Long))";
    ...
    public static class PrimitiveMatching_Advices extends Advice.AbstractAfter<Long, RuntimeException> 
        ...
        public PojoPointcutSpec getAspectSpec() {
            return new AspectSpec.PojoPointcutSpec.Builder()
                    ...
                    .typeMatcher(
                            named("io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$PrimitiveMatching_Objects") )
                    .methodMatcher(
    ...
    public static class GenericMatching_Aspects {
        ...
        private static final String MATCH_GENERIC_POINTCUT = 
                "execution(java.lang.Number io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$GenericMatching_Objects.matchGeneric(java.lang.Number))";
    ...
    public static class GenericMatching_Advices extends Advice.AbstractAfter<Number, RuntimeException> 
        ...
        public PojoPointcutSpec getAspectSpec() {
            return new AspectSpec.PojoPointcutSpec.Builder()
                    ...
                    .typeMatcher(
                            named("io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$GenericMatching_Objects") )
                    .methodMatcher(
                            named("matchGeneric")
                                .and(isPublic())
    ...
    public static class GenericArrayMatching_Aspects {
        ...
        private static final String MATCH_GENERIC_ARRAY_POINTCUT = 
                "execution(java.lang.Number[] io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$GenericArrayMatching_Objects.matchGenericArray(java.lang.Number[]))";
    ...
    public static class GenericArrayMatching_Advices extends Advice.AbstractAfter<Number[], RuntimeException> 
        ...
        public PojoPointcutSpec getAspectSpec() {
            return new AspectSpec.PojoPointcutSpec.Builder()
                    ...
                    .typeMatcher(
                            named("io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$GenericArrayMatching_Objects") )
                    .methodMatcher(
    ...
    public static class GenericCollectionMatching_Aspects {
        ...
        private static final String MATCH_GENERIC_COLLECTION_POINTCUT = 
                "execution(java.util.List io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$GenericCollectionMatching_Objects.matchGenericCollection(java.util.List))";
    ...
    public static class GenericCollectionMatching_Advices extends Advice.AbstractAfter<List, RuntimeException> 
        ...
        public PojoPointcutSpec getAspectSpec() {
            return new AspectSpec.PojoPointcutSpec.Builder()
                    ...
                    .typeMatcher(
                            named("io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$GenericCollectionMatching_Objects") )
                    .methodMatcher(
    ...
    public static class ParameterizedCollectionMatching_Aspects {
        ...
        private static final String MATCH_PARAMETERIZED_COLLECTION_POINTCUT = 
                "execution(java.util.List<java.lang.String> io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$ParameterizedCollectionMatching_Objects.matchParameterizedCollection(java.util.List<java.lang.String>))";
    ...
    public static class ParameterizedCollectionMatching_Advices extends Advice.AbstractAfter<List<String>, RuntimeException> 
        ...
        public PojoPointcutSpec getAspectSpec() {
            return new AspectSpec.PojoPointcutSpec.Builder()
                    ...
                    .typeMatcher(
                            named("io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$ParameterizedCollectionMatching_Objects") )
                    .methodMatcher(
    ...
    public static class WildCardCollectionMatching_Aspects {
        ...
        private static final String MATCH_WILD_CARD_COLLECTION_POINTCUT = 
                "execution(java.util.List<? extends java.lang.Number> io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$WildCardCollectionMatching_Objects.matchWildCardCollection(java.util.List<? extends java.lang.Number>))";
    ...
    public static class WildCardCollectionMatching_Advices extends Advice.AbstractAfter<List<? extends Number>, RuntimeException> 
        ...
        public PojoPointcutSpec getAspectSpec() {
            return new AspectSpec.PojoPointcutSpec.Builder()
                    ...
                    .typeMatcher(
                            named("io.gemini.aop.aspect.Pointcut_01JoinpointMatching_Tests$WildCardCollectionMatching_Objects") )
                    .methodMatcher(
