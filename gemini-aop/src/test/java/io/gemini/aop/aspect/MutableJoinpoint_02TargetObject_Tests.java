 ...
 * @since	 1.0
 */
public class MutableJoinpoint_02TargetObject_Tests extends AbstractBaseTests {
    ...
    public static class TypeInitilizer_BeforeAdvice_Aspects {
        ...
        @Before("staticinitialization(io.gemini.aop.aspect.MutableJoinpoint_02TargetObject_Tests$TypeInitilizer_BeforeAdvice_Objects)")
    ...
    public static class TypeInitilizer_AfterAdvice_Aspects {
        ...
        @SuppressWarnings("rawtypes")
        @Before("staticinitialization(io.gemini.aop.aspect.MutableJoinpoint_02TargetObject_Tests$TypeInitilizer_AfterAdvice_Objects)")
        public void typeInitializer(MutableJoinpoint joinpoint) {
            ExecutionMemento.putAdviceMethodInvoker(ADVICE_TYPE_INITIALIZER, 
                    new AdviceMethod()
                        .withInvoked(true)
    ...
    public static class ClassMethod_Advices {
        ...
        private static final String TARGET_OBJECT_POINTCUT = 
                "execution(public static void io.gemini.aop.aspect.MutableJoinpoint_02TargetObject_Tests$ClassMethod_Objects.targetObject())";
    ...
    public static class InstanceConstructor_Advices {
        ...
        private static final String TARGET_OBJECT_POINTCUT = 
                "execution(public io.gemini.aop.aspect.MutableJoinpoint_02TargetObject_Tests$InstanceConstructor_Objects.new(boolean))";
    ...
    public static class InstanceMethod_Aspects {
        ...
        private static final String TARGET_OBJECT_POINTCUT = 
                "execution(public void io.gemini.aop.aspect.MutableJoinpoint_02TargetObject_Tests$InstanceMethod_Objects.targetObject())";
