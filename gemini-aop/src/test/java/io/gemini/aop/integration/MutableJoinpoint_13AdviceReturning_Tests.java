...
public class MutableJoinpoint_13AdviceReturning_Tests extends AbstractIntegrationTests {
    ...
    public static class TypeInitilizer_BeforeAdvice_Aspects {
        ...
        @Before("staticinitialization(io.gemini.aop.integration.MutableJoinpoint_13AdviceReturning_Tests$TypeInitilizer_BeforeAdvice_Objects)")
    ...
    public static class TypeInitilizer_AfterAdvice_Aspects {
        ...
        @SuppressWarnings({ "rawtypes", "unchecked" })
        @Before("staticinitialization(io.gemini.aop.integration.MutableJoinpoint_13AdviceReturning_Tests$TypeInitilizer_AfterAdvice_Objects)")
        public void typeInitializer(MutableJoinpoint joinpoint) {
            ExecutionMemento.putAdviceMethodInvoker(ADVICE_TYPE_INITIALIZER, 
                    new AdviceMethod().withInvoked(true) );
            joinpoint.setAdviceReturning(null);
    ...
    public static class ClassMethod_Advices {
        ...
        private static final String BEFORE_ADVICE_RETURNING_POINTCUT = 
                "execution(public static * io.gemini.aop.integration.MutableJoinpoint_13AdviceReturning_Tests$ClassMethod_Objects.beforeAdviceReturning())";
        ...
        private static final String AFTER_ADVICE_RETURNING_POINTCUT = 
                "execution(public static * io.gemini.aop.integration.MutableJoinpoint_13AdviceReturning_Tests$ClassMethod_Objects.afterAdviceReturning())";
    ...
    public static class InstanceConstructor_Advices {
        ...
        private static final String BEFORE_ADVICE_RETURNING_POINTCUT = 
                "execution(public io.gemini.aop.integration.MutableJoinpoint_13AdviceReturning_Tests$InstanceConstructor_Objects.new(boolean))";
        ...
        private static final String AFTER_ADVICE_RETURNING_BEFORE_ADVICE = "afterAdviceReturning_before";
        private static final String AFTER_ADVICE_RETURNING_AFTER_ADVICE = "afterAdviceReturning_after";
        private static final String AFTER_ADVICE_RETURNING_POINTCUT = "execution(public io.gemini.aop.integration.MutableJoinpoint_13AdviceReturning_Tests$InstanceConstructor_Objects.new(byte))";
    ...
    public static class InstanceMethod_Aspects {
        ...
        private static final String BEFORE_ADVICE_RETURNING_POINTCUT = 
                "execution(public * io.gemini.aop.integration.MutableJoinpoint_13AdviceReturning_Tests$InstanceMethod_Objects.beforeAdviceReturning())";
        ...
        private static final String AFTER_ADVICE_RETURNING_POINTCUT = 
                "execution(public * io.gemini.aop.integration.MutableJoinpoint_13AdviceReturning_Tests$InstanceMethod_Objects.afterAdviceReturning())";
