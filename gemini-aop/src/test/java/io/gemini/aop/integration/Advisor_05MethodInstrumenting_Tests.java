...
public class Advisor_05MethodInstrumenting_Tests extends AbstractIntegrationTests {
    ...
    public void testTypeInitializer() {
        new TypeInitializer_Object();

        {
            AdviceMethod adviceMethodInvoker = ExecutionMemento.getAdviceMethodInvoker(TypeInitializer_Aspect.ADVICE_TYPE_INITIALIZER);
            assertThat(adviceMethodInvoker).isNotNull();
            assertThat(adviceMethodInvoker.isInvoked()).isTrue();

            TargetMethod targetMethodInvoker = ExecutionMemento.getTargetMethodInvoker(TypeInitializer_Object.class.getName());
            assertThat(targetMethodInvoker).isNotNull();
            assertThat(targetMethodInvoker.isInvoked()).isTrue();
        }
    }

    public static class TypeInitializer_Object {
        static {
            ExecutionMemento.putTargetMethodInvoker(TypeInitializer_Object.class.getName(), 
        ...
        static {
            LOGGER = LoggerFactory.getLogger(TypeInitializer_Object.class);
        }
    }

    @Aspect
    public static class TypeInitializer_Aspect {
    ...
    public void testClassMethod() {
        ClassMethod_Object.classMethod();

        AdviceMethod afterAdviceMethodInvoker = ExecutionMemento.getAdviceMethodInvoker(ClassMethod_Aspect.CLASS_METHOD_AFTER_ADVICE);
    ...
    public void testInstanceConstructor() {
        ...
        AdviceMethod afterAdviceMethodInvoker = ExecutionMemento.getAdviceMethodInvoker(InstanceConstructor_Aspect.INSTANCE_CONSTRUCTOR_AFTER_ADVICE);
        assertThat(afterAdviceMethodInvoker).isNotNull();
        assertThat(afterAdviceMethodInvoker.isInvoked()).isTrue();
    }
    ...
    public static class InstanceConstructor_Object {
        ...
        public InstanceConstructor_Object(byte input) {
        }
    }
    ...
    public void testInstanceMethod() {
        ...
        AdviceMethod afterAdviceMethodInvoker = ExecutionMemento.getAdviceMethodInvoker(InstanceMethod_Aspect.INSTANCE_METHOD_AFTER_ADVICE);
        assertThat(afterAdviceMethodInvoker).isNotNull();
        assertThat(afterAdviceMethodInvoker.isInvoked()).isTrue();
    }
    ...
    public void testInterfaceMethod() {
        Interface_Object expected = new InterfaceImplementor_Object();

        {
            ...
            assertThat(afterAdviceMethodInvoker2.getStaticPart()).isEqualTo(InterfaceImplementor_Object.IMPLEMENTOR_INTERFACE_METHOD);
        }

        {
            expected.defaultMethod();

            AdviceMethod afterAdviceMethodInvoker = ExecutionMemento.getAdviceMethodInvoker(InterfaceImplementor_Aspect.DEFAULT_METHOD_AFTER_ADVICE);
            assertThat(afterAdviceMethodInvoker).isNotNull();
            assertThat(afterAdviceMethodInvoker.isInvoked()).isTrue();
            assertThat(afterAdviceMethodInvoker.getStaticPart()).isEqualTo(InterfaceImplementor_Object.DEFAULT_METHOD);

            AdviceMethod afterAdviceMethodInvoker2 = ExecutionMemento.getAdviceMethodInvoker(InterfaceImplementor_Aspect.IMPLEMENTOR_DEFAULT_METHOD_AFTER_ADVICE);
            assertThat(afterAdviceMethodInvoker2).isNotNull();
            assertThat(afterAdviceMethodInvoker2.isInvoked()).isTrue();
            assertThat(afterAdviceMethodInvoker2.getStaticPart()).isEqualTo(InterfaceImplementor_Object.IMPLEMENTOR_DEFAULT_METHOD);
        }
    }

    static interface Interface_Object {
    ...
    public static class InterfaceImplementor_Object implements Interface_Object {
        ...
        public void defaultMethod() {
            Interface_Object.super.defaultMethod();
        }
    }
    ...
    public void testBridgeMethod() {
        BridgeMethod_Object expected = new BridgeMethod_Object();

        {
            ...
            AdviceMethod afterAdviceMethodInvoker = ExecutionMemento.getAdviceMethodInvoker(BridgeMethod_Aspect.GENERIC_BRIDGE_AFTER_ADVICE);
            assertThat(afterAdviceMethodInvoker).isNotNull();
            assertThat(afterAdviceMethodInvoker.isInvoked()).isTrue();
            assertThat(afterAdviceMethodInvoker.getStaticPart()).isEqualTo(BridgeMethod_Object.GENERIC_BRIDGE);

            AdviceMethod afterAdviceMethodInvoker2 = ExecutionMemento.getAdviceMethodInvoker(BridgeMethod_Aspect.OVERRIDDEN_GENERIC_BRIDGE_AFTER_ADVICE);
            assertThat(afterAdviceMethodInvoker2).isNotNull();
            assertThat(afterAdviceMethodInvoker2.isInvoked()).isTrue();
            assertThat(afterAdviceMethodInvoker2.getStaticPart()).isEqualTo(BridgeMethod_Object.GENERIC_BRIDGE);
        }

        {
            expected.covariantBridge();

            AdviceMethod afterAdviceMethodInvoker = ExecutionMemento.getAdviceMethodInvoker(BridgeMethod_Aspect.COVARIANT_BRIDGE_AFTER_ADVICE);
            assertThat(afterAdviceMethodInvoker).isNotNull();
            assertThat(afterAdviceMethodInvoker.isInvoked()).isTrue();
            assertThat(afterAdviceMethodInvoker.getStaticPart()).isEqualTo(BridgeMethod_Object.COVARIANT_BRIDGE);

            AdviceMethod afterAdviceMethodInvoker2 = ExecutionMemento.getAdviceMethodInvoker(BridgeMethod_Aspect.OVERRIDDEN_COVARIANT_BRIDGE_AFTER_ADVICE);
            assertThat(afterAdviceMethodInvoker2).isNotNull();
            assertThat(afterAdviceMethodInvoker2.isInvoked()).isTrue();
            assertThat(afterAdviceMethodInvoker2.getStaticPart()).isEqualTo(BridgeMethod_Object.COVARIANT_BRIDGE);
        }
    }

    static interface GenericInterface_Object<T> {
    ...
    public static class BridgeMethod_Object implements GenericInterface_Object<String> {
