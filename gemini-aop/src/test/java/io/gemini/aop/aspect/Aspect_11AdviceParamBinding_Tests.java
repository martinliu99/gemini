 ...
 * @since	 1.0
 */
public class Aspect_11AdviceParamBinding_Tests extends AbstractBaseTests {
    ...
    public static class TargetObjectBinding_Aspects {
        ...
        private static final String BIND_TARGET_OBJECT_POINTCUT = 
                "execution(!private long io.gemini.aop.aspect.Aspect_11AdviceParamBinding_Tests$TargetObjectBinding_Objects.bindTargetObject()) && this(targetObject)";
    ...
    public static class TargetArgumentBinding_Aspects {
        ...
        private static final String BIND_TARGET_ARGUMENT_POINTCUT = 
                "execution(!private long io.gemini.aop.aspect.Aspect_11AdviceParamBinding_Tests$TargetArgumentBinding_Objects.bindTargetArgument(..)) && args(_long, string)";
        ...
        private static final String BIND_PARTIAL_PARAMS_POINTCUT = 
                "execution(!private long io.gemini.aop.aspect.Aspect_11AdviceParamBinding_Tests$TargetArgumentBinding_Objects.bindTargetArgument(..)) && args(_long, ..)";
    ...
    public static class TargetReturningBinding_Aspects {
        ...
        private static final String BIND_TARGET_RETURNING_POINTCUT = 
                "execution(!private long io.gemini.aop.aspect.Aspect_11AdviceParamBinding_Tests$TargetReturningBinding_Objects.bindTargetReturning())";
        ...
        private static final String BIND_WRONG_TYPE_POINTCUT = 
                "execution(* io.gemini.aop.aspect.Aspect_11AdviceParamBinding_Tests$TargetReturningBinding_Objects.bindTargetReturning())";
    ...
    public static class TargetThrowingBinding_Aspects {
        ...
        private static final String BIND_TARGET_THROWING_POINTCUT = 
                "execution(!private void io.gemini.aop.aspect.Aspect_11AdviceParamBinding_Tests$TargetThrowingBinding_Objects.bindTargetThrowing())";
