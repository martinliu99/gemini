...
public class Pointcut_11AspectJExprMatching_Tests extends AbstractBaseTests {
    ...
    public static class LogicalOperator_Aspects {
        ...
        private static final String MATCH_LOGICAL_OPERATOR_POINTCUT = 
                "execution(!private long io.gemini.aop.aspect.Pointcut_11AspectJExprMatching_Tests$LogicalOperator_Objects.matchLogicalOperator(long))"
                + " or "
                + "execution(!private java.lang.Long io.gemini.aop.aspect.Pointcut_11AspectJExprMatching_Tests$LogicalOperator_Objects.matchLogicalOperator(java.lang.Long))";
        ...
        @Pointcut("execution(!private long io.gemini.aop.aspect.Pointcut_11AspectJExprMatching_Tests$LogicalOperator_Objects.matchLogicalOperator(long))")
        public void matchLogicalOperator() { }

        @Pointcut("execution(!private java.lang.Long io.gemini.aop.aspect.Pointcut_11AspectJExprMatching_Tests$LogicalOperator_Objects.matchLogicalOperator(java.lang.Long))")
