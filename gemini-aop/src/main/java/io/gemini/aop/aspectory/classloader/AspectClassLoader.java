 ...
 */
package io.gemini.aop.aspectory.classloader;
...
/**
 * <p>
 * This specialized ClassLoader contains two parent CLassLoaders. One ClassLoader includes Aspectory resources 
 * and delegates to {@code AopClassLoader} to load user-defined Advice, Pointcut, AspectSpec classes and AOP framework 
 ...
 * 
 * <p>
 * AspectClassLoader loads class from Aspectory resources firstly. If not found, then delegates to application 
...
public abstract class AspectClassLoader extends URLClassLoader {
     ...
     */
    public AspectClassLoader(String aspectoryName, URL[] urls, AopClassLoader aopClassLoader) {
        super(urls, aopClassLoader);

        Assert.hasText(aspectoryName, "'aspectory' must not be empty.");
    ...
    public static class WithThreadContextCL extends AspectClassLoader {
        ...
        public WithThreadContextCL(String aspectoryName, URL[] urls, AopClassLoader aopClassLoader) {
    ...
    public static class WithJoinpointCL extends AspectClassLoader {
        ...
        public WithJoinpointCL(String aspectoryName, URL[] urls, AopClassLoader aopClassLoader, 
