...
public interface AspectJAdvice {
    ...
    class ClassMaker {
        ...
        public Class<? extends Advice> make(AspectContext aspectContext) {
            ClassLoader cacheKey = aspectContext.getClassLoader();
            ...
            if(adviceClassRefMap.containsKey(cacheKey) == false) {
                adviceClassRefMap.computeIfAbsent(
                        ...
                        key -> {
                            ...
                            this.adviceClassUnloaded = ByteCodeGenerator.INSTANCE.make(aspectContext, this);
    ...
    enum ByteCodeGenerator {
        ...
        @SuppressWarnings("unchecked")
        public DynamicType.Unloaded<? extends Advice> make(AspectContext aspectContext, ClassMaker classMaker) {
